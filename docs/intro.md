...
Installing a [helper package](https://github.com/particle1331/inefficient-networks/tree/master/src) for making life easier. This contains functions for downloading datasets from Kaggle , setting up paths, and configuring random seeds and plots. Note that code can be easily refactored to not have this dependency. 

```text
pip install inefficient-networks==0.1.1
```
