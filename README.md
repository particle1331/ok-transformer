...
to explore](http://www.paulgraham.com/getideas.html). I take great 
pains (or many re-runs) to ensure that the notebooks run end-to-end 
with reasonably reproducible results across runs. Note that specific 
values may change (e.g. with different hardware or external dataset 
versions), but correct conclusions should still hold. 
